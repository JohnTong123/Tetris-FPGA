...
#
# Generated by Vivado on Wed Mar 26 23:21:53 -0500 2025
...
simulate()
{
  xsim  clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/ml_block.protoinst" -log simulate.log
}
