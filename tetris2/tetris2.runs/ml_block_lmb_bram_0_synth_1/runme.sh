...
HD_PWD='C:/Users/johna/Tetris-FPGA/tetris2/tetris2.runs/ml_block_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ml_block_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ml_block_lmb_bram_0.tcl
