...
HD_PWD='C:/Users/johna/Tetris-FPGA/tetris2/tetris2.runs/ml_block_microblaze_0_axi_intc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ml_block_microblaze_0_axi_intc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ml_block_microblaze_0_axi_intc_0.tcl
